...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const camp = new Campground({
            ...
            description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores ipsum aliquid odit officia, est ullam expedita sapiente repellendus, dolorum tenetur, commodi excepturi animi odio molestias modi similique quaerat facere tempore!",
            price 
        });
        await camp.save();
    }
